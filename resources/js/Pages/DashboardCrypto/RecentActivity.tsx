                            ...
                            <div className="p-3">
                                ...
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="flex-shrink-0 text-end">
                                        ...
                                        <p className="text-muted fs-14 mb-0">+878.52 USD</p>
                                    </div>
                                </div>
                                <div className="d-flex align-items-center mt-3">
                                    ...
                                    <div className="flex-shrink-0 text-end">
                                        ...
                                        <p className="text-muted fs-14 mb-0">-659.35 USD</p>
                                    </div>
                                </div>
                                ...
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="flex-shrink-0 text-end">
                                        ...
                                        <p className="text-muted fs-14 mb-0">-1508.98 USD</p>
                                    </div>
                                </div>
                                <div className="d-flex align-items-center mt-3">
                                    <div className="avatar-xs flex-shrink-0">
                                    ...
                                    <div className="flex-shrink-0 text-end">
                                        ...
                                        <p className="text-muted fs-14 mb-0">-89.36 USD</p>
                                    </div>
                                </div>
                                <div className="d-flex align-items-center mt-3">
                                    <div className="avatar-xs flex-shrink-0">
                                    ...
                                    <div className="flex-shrink-0 text-end">
                                        ...
                                        <p className="text-muted fs-14 mb-0">+759.45 USD</p>
                                    </div>
                                </div>
